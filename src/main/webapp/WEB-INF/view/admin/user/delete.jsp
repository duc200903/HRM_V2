...
<html lang="en">
  <head>
   <meta charset="UTF-8" />
    ...
    <title>Xóa người dùng - HRM System</title>
              ...
              <div class="card border-danger">
                ...
                <div class="card-body">
                  <div class="alert alert-warning">
                    <h6>
                      <i class="fas fa-warning me-2"></i>Bạn có chắc chắn muốn xóa người dùng này?
                    </h6>
                    <hr>
                    <p><strong>ID:</strong> ${id}</p>
                    <p><strong>Tên đăng nhập:</strong> ${name}</p>
                    <p class="mb-0 text-danger">
                      <small><i class="fas fa-info-circle me-1"></i>Hành động này không thể hoàn tác!</small>
                    </p>
                  </div>
