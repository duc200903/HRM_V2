...
<html lang="en">
    <head>
        ...
        <title>Xóa nhân viên - HRM System</title>
                            ...
                            <div class="card border-danger">
                                ...
                                <div class="card-body">
                                    <div class="alert alert-warning">
                                        <h6>
                                            <i class="fas fa-warning me-2"></i>Bạn có chắc chắn muốn xóa nhân viên này?
                                        </h6>
                                        <hr />
                                        <p><strong>ID:</strong> ${newEmployee.id}</p>
                                        <p><strong>Họ và tên:</strong> ${newEmployee.fullName}</p>
                                        <c:if test="${not empty newEmployee.user}">
                                            <p>
                                                <strong>Tài khoản:</strong> ${newEmployee.user.username}
                                                (${newEmployee.user.email})
                                            </p>
                                        </c:if>
                                        <c:if test="${not empty newEmployee.department}">
                                            <p>
                                                <strong>Phòng ban:</strong>
                                                ${newEmployee.department.name}
                                            </p>
                                        </c:if>
                                        <c:if test="${not empty newEmployee.employeeCode}">
                                            <p>
                                                <strong>Mã nhân viên:</strong>
                                                ${newEmployee.employeeCode}
                                            </p>
                                        </c:if>
                                        <c:if test="${not empty newEmployee.position}">
                                            <p>
                                        ...
                                        <p class="mb-0 text-danger">
                                            <small
                                                ...
                                                tác! Tài khoản liên kết và tất cả dữ liệu liên quan (lương, đào tạo,
                                                đánh giá) sẽ bị xóa.</small
                                            >
                                        </p>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a
                                            href="/admin/employee/delete/${newEmployee.id}/confirm"
