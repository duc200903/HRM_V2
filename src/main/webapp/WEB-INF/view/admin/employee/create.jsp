...
<html lang="en">
    <head>
        ...
        <title>Tạo nhân viên mới - HRM System</title>
                        ...
                        <div class="mt-4">
                            ...
                            >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <small class="form-text text-muted">
                                                    <i class="fas fa-info-circle me-1"></i>Để trống để sử dụng ngày hiện
                                                    tại
                                                </small>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                />
                                                <small class="form-text text-muted">
                                                    <i class="fas fa-info-circle me-1"></i>Để trống để hệ thống tự động
                                                    tạo mã
                                                </small>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label for="remainingLeaveDays" class="form-label">
                                                    <i class="fas fa-calendar-alt me-1"></i>Số ngày phép/năm
                                                </label>
                                                <form:input
                                                    type="number"
                                                    class="form-control"
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <small>
                                        Các trường có dấu (*) là bắt buộc. Nhân viên sẽ có thể đăng nhập với tài khoản
                                        được tạo.
                                    </small>
                                </div>
