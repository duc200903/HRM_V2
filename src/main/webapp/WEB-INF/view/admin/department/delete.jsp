...
<html lang="en">
    <head>
        ...
        <title>Xóa phòng ban - HRM System</title>
                        ...
                        <div class="mt-4 w-50 mx-auto">
                            <div class="card border-danger">
                                <div class="card-header bg-danger text-white">
                                    <h5 class="mb-0">
                                        <i class="fas fa-exclamation-triangle me-2"></i>Xác nhận xóa phòng ban
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="alert alert-warning">
                                        <h6>
                                            <i class="fas fa-warning me-2"></i>Bạn có chắc chắn muốn xóa phòng ban này?
                                        </h6>
                                        <hr />
                                        <p><strong>ID:</strong> ${id}</p>
                                        <p><strong>Tên phòng ban:</strong> ${name}</p>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <form:form
                                            ...
                                            action="/admin/department/delete/${id}"
                                        >
