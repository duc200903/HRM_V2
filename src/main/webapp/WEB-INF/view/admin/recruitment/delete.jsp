...
<html lang="en">
    <head>
        ...
        <title>Xóa tin tuyển dụng - HRM System</title>
                        ...
                        <div class="mt-4 w-50 mx-auto">
                            <div class="card border-danger">
                                <div class="card-header bg-danger text-white">
                                    <h5 class="mb-0">
                                        <i class="fas fa-exclamation-triangle me-2"></i>Xác nhận xóa tin tuyển dụng
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="alert alert-warning">
                                        <h6>
                                            <i class="fas fa-warning me-2"></i>Bạn có chắc chắn muốn xóa tin tuyển dụng
                                            này?
                                        </h6>
                                        <hr />
                                        <p><strong>ID:</strong> ${recruitment.id}</p>
                                        <p><strong>Vị trí:</strong> ${recruitment.title}</p>
                                        <p>
                                            <strong>Phòng ban:</strong>
                                            <c:choose>
                                                <c:when test="${not empty recruitment.department}"
                                                    >${recruitment.department.name}</c:when
                                                >
                                                <c:otherwise
                                                    ><span class="text-muted">Chưa phân phòng</span></c:otherwise
                                                >
                                            </c:choose>
                                        </p>
                                        <p>
                                            ...
                                            <span
                                                ...
                                                >${recruitment.status.name() == 'open' ? 'Đang mở' : 'Đã đóng'}</span
                                            >
                                        </p>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <form method="post" action="/admin/recruitment/delete/${recruitment.id}">
