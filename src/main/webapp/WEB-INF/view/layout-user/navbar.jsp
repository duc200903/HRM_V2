...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
    <div class="container">
        <a class="navbar-brand fw-bold" href="/home">
            <i class="fas fa-building me-2"></i>HRM System
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/my-leave">
                        <i class="fas fa-calendar-alt me-1"></i>Nghỉ phép
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/my-salary">
                        <i class="fas fa-money-bill-wave me-1"></i>Lương thưởng
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/my-training">
                        <i class="fas fa-graduation-cap me-1"></i>Đào tạo
                    </a>
                </li>
